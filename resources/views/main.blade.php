      ...
      {{-- <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="#" class="nav-link" onclick="loadAddBranchForm()">
                  {{-- <i class="far fa-circle nav-icon"></i> --}}
                  {{-- <p>Add Branch</p>
                </a>
              </li>
              ...
              {{-- <li class="nav-item">
                <a href="pages/charts/inline.html" class="nav-link">
                  {{-- <i class="far fa-circle nav-icon"></i> --}}
                  {{-- <p>View Branch/payout Details</p>
                </a>
              </li>
            </ul>
          </li> --}} 
          {{-- <li class="nav-item">
            ...
            {{-- <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('/leads/add-lead')}}" class="nav-link">
                  {{-- <i class="far fa-circle nav-icon"></i> --}}
                  {{-- <p>Add Lead</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ url('/show-leads')}}" class="nav-link">
                  {{-- <i class="far fa-circle nav-icon"></i> --}}
                  {{-- <p>View Leads</p>
                </a>
              </li>
