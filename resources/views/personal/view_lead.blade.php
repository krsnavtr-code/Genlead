    ...
    <div class="lead-details-container">
        ...
        <div class="lead-left">
            ...
            <div class="lead-header">
                <!-- Back Button -->
                <a href="/i-admin/show-leads" class="btn btn-secondary"
                    style="margin-right: 15px; margin-left: -33px; margin-top:-67px;">Back</a>
        ...
        <div class="lead-right">
            ...
            <div id="lead-details" class="tab-content active-content">
                ...
                {{-- <div class="lead-section">
                    ...
                    <div id="leadInfo" class="collapsible-content visible">
                        <div class="lead-info-box">
                            ...
                            <div><span class="eWUmU">Lead Source:</span><span class="lagyBr"> {{ $lead->lead_source
                                    }}</span> </div>
                            <!-- <div><span class="eWUmU">Lead Status:</span><span class="lagyBr">{{ ucfirst($lead->lead_status) }}</span></div> -->
                        </div>
                        <div class="lead-info-box">
                            <div><span class="eWUmU">University:</span><span class="lagyBr">{{ ucfirst($lead->university)
                                    }}</span></div>
                            <div><span class="eWUmU">Course:</span><span class="lagyBr">{{ ucfirst($lead->courses) }}</span>
                            </div>
                            <div><span class="eWUmU">College:</span><span class="lagyBr">{{ ucfirst($lead->college)
                                    }}</span></div>
                            <div><span class="eWUmU">Branch:</span><span class="lagyBr">{{ ucfirst($lead->branch) }}</span>
                            </div>
                        </div>
                        <div class="lead-info-box">
                ...
                <div class="container my-4">
                    <div class="card shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
                            ...
                            <span id="iconLead" onclick="toggleSection('leadInfo', 'iconLead')"
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div id="courseEdit" class="input-group d-none">
                                            <input type="text" id="courseInput" class="form-control form-control-sm"
                                                value="{{ $lead->courses }}">
                ...
                <div style="text-align: left; margin-top: 20px;">
                    <a href="{{ route('payment.page', ['leadId' => $lead->id]) }}" class="btn btn-primary">Proceed to
                        Payment Page</a>
                </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="card summary-card bg-light">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-success">₹{{ number_format($lead->payments->sum('payment_amount'), 2) }}
                                    </h5>
                                </div>
                            </div>
                        </div>
        ...
        <form method="POST" action="">
            ...
            <div class="lead-info-box">
                ...
                <div>
                    ...
                    <input type="text" id="lead_source" name="lead_source" class="form-control"
